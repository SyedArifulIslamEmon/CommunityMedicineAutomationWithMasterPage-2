<%@ Page Title="" Language="C#" MasterPageFile="~/UI/centerControl.Master" AutoEventWireup="true" CodeBehind="DiseaseEntryUI.aspx.cs" ValidateRequest="false" Inherits="CommunityMedicineAutomationApp.UI.DiseaseEntryUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel runat="server" ID="diseaseEntryPanel" GroupingText="Disease Entry"  HorizontalAlign="Left">
        ...
        <br/>
        <br/>
        <asp:GridView runat="server" ID="diseaseGridView" Width="825px" AutoGenerateColumns="False" Height="77px" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" CellPadding="3" GridLines="Horizontal"   >
