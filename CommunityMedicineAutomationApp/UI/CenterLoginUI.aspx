<%@ Page Title="" Language="C#" MasterPageFile="~/UI/centerControl.Master" AutoEventWireup="true" CodeBehind="centerLoginUI.aspx.cs" Inherits="CommunityMedicineAutomationApp.UI.centerLoginUI" %>
    ...
    <asp:Panel runat="server" ID="centerLoginPanel">
        <table>
            ...
            <tr>
                ...
                <td>
                     <asp:TextBox runat="server" ID="passwordTextBox" Width="220"/><br/> <br/> 
                </td>
            </tr>
